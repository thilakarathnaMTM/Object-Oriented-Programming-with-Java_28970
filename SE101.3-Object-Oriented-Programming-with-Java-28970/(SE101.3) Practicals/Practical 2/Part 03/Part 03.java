...
//2. A software object's state is stored in **fields** (or instance variables).
...
//6. Common behavior can be defined in a **base class** and inherited into a **subclass** using the **extends** keyword.
